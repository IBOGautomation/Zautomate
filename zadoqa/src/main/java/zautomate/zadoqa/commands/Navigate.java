...
public class Navigate {
	...
	//////////////////////////////////////////////////////////
	public static void getFair(WebDriver driver)
	{
		driver.get(Directory.FAIR_URL);
	}
	public static void getANL(WebDriver driver)
	{
		driver.get(Directory.ANL_URL);
	}
	...
	public static String alertAccept(WebDriver driver) {
		try{Thread.sleep(1000);}catch(InterruptedException e){e.printStackTrace();}
		Alert alert = driver.switchTo().alert();
		String alertText = alert.getText();
		alert.accept();
	...
	public static String verifyalertAccept(WebDriver driver, String inputdata) {
		try{Thread.sleep(1000);}catch(InterruptedException e){e.printStackTrace();}
		Alert alert = driver.switchTo().alert();
		String alertText = alert.getText();
		if(alertText.equalsIgnoreCase(inputdata.trim()))
		{
			alert.accept();
		}
		return alertText;
