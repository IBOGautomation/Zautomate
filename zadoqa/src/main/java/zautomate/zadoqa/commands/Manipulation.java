...
import zautomate.zadoqa.config.ApplicationConstants;
...
public class Manipulation extends CommandUtils implements OR {
	...
	public static String clickAndType(WebElement webElement, String keysToSend) {
		webElement.click();
	...
	public static String selectByValue(WebElement element, String inputData) {
		try {
			Select selectBox = new Select(element);
